...
catalogs.forEach((val, index) => {
    val.addEventListener('mouseover', function() {
        val.src = "http://localhost:8888/seven-thirty/public/img/" + catPics[index] + "-zoomed.jpg";
...
catalogs.forEach((val, index) => {
    val.addEventListener('mouseout', function() {
        val.src = "http://localhost:8888/seven-thirty/public/img/" + catPics[index] + ".jpg";
        val.classList.remove('fadeIn');
    })
});

thumb2.addEventListener('click', function() {
    previewImg.src = "http://localhost:8888/seven-thirty/public/img/" + product + "-zoomed.jpg";
    event.preventDefault();
    previewImg.classList.add('fadeIn');
    setTimeout(function(){ 
    previewImg.classList.remove('fadeIn'); }, 200);
});

thumb1.addEventListener('click', function() {
    previewImg.src = "http://localhost:8888/seven-thirty/public/img/" + product + ".jpg";
    event.preventDefault();
    previewImg.classList.add('fadeIn');
    setTimeout(function(){ 
    previewImg.classList.remove('fadeIn')}, 200);
