...
let catPics = ['friendship', 'anxiety', 'forgiving', 'paramore', 'blackpink', 'hayley', 'purpose', 'zayn', 'travis', 'beerbongs', 'dualipa', 'drake', 'dynamite', 'hollywoods', 'lookmom', 'modernity', 'billie', 'starboy'];
