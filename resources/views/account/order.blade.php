        ...
        <div class="col-xl-9">
          ...
          <table class="mt-3 table">
            <tr>
              ...
              <td style="vertical-align: middle; padding-left: 0;" class="ml-1" width="65%"><span class="font-weight-bold">Anxiety Disorder - T Shirt</span><br>
              <span class="text-muted">XL - 1 pcs</span></td>
              <td style="vertical-align: middle; padding-right: 0; text-align: center;" width="30%" class="font-weight-bold"><span>Rp. 180.000,-</span></td>
            </tr>
          </table>
        </div>
    </div>
