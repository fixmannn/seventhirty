...
<div class="products">
    <div class="products-desc">
        <div class="thumbnail">
            <a href=""><img src="{{asset('img/travis.jpg')}}" alt="" class="thumb1"></a>
            <a href=""><img src="{{asset('img/travis-zoomed.jpg')}}" alt="" class="thumb2"></a>
        </div>
        <div class="preview">
            <a href=""><img src="{{asset('img/travis.jpg')}}" alt="" class="img-fluid previewImg img1"></a>
        </div>
    ...
    <!-- Related Products -->
    @include('products/related/travis')
</div>
...
<script>
    ...
    let catPics = ['hayley', 'blackpink', 'drake', 'hollywoods'];
</script>
