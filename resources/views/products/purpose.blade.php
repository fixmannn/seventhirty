...
<div class="products">
    <div class="products-desc">
        <div class="thumbnail">
            <a href=""><img src="{{asset('img/purpose.jpg')}}" alt="" class="thumb1"></a>
            <a href=""><img src="{{asset('img/purpose-zoomed.jpg')}}" alt="" class="thumb2"></a>
        </div>
        <div class="preview">
            <a href=""><img src="{{asset('img/purpose.jpg')}}" alt="" class="img-fluid previewImg img1"></a>
        </div>
