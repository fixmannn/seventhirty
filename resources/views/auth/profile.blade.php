...
<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <a class="navbar-brand mr-auto" href="{{url('/')}}">SEVEN THIRTY</a>
  <div class="collapse navbar-collapse ml-auto" id="navbarNavAltMarkup">
    <div class="navbar-nav menu mx-auto">
      <a class="nav-link text-body" href="{{url('/')}}">Home <span class="sr-only">(current)</span></a>
      <a class="nav-link text-body" href="{{url('/shop')}}">Shop</a>
      <a class="nav-link text-body" href="{{url('/gallery')}}">Gallery</a>
      <a class="nav-link text-body" href="{{url('/about')}}">About us</a>
    </div>
  </div>
  <div class="navbar-nav">
    ...
    @endif
    <a href="{{url('/cart')}}" class="nav-link icons text-body"><i class="bi bi-cart text-body"></i></a>
  </div>
</nav>
<!-- End of Navbar -->
...
<div class="container new-arrival">
  ...
  <div class="row new-catalog">
    <div class="col-xl">
      <a href="./products/blackpink.php" style="text-decoration: none;"><img src="{{asset('img/blackpink.jpg')}}" alt="" class="catalog">
        <h5>Blackpink Vintage T-shirt</h5>
      </a>
      <p>Rp. 99.000,-</p>
    </div>
    <div class="col-xl">
      <a href="./products/hayley.php" style="text-decoration: none;"><img src="{{asset('img/hayley.jpg')}}" alt="" class="catalog">
        <h5>Hayley Williams Vintage T-shirt</h5>
      </a>
      <p>Rp. 99.000,-</p>
    </div>
    <div class="col-xl">
      <a href="./products/travis.php" style="text-decoration: none;"><img src="{{asset('img/travis.jpg')}}" alt="" class="catalog">
  ...
  <div class="load-more">
    <a href="{{url('/shop')}}" style="text-decoration: none;" class="text-muted">
      <p>LOAD MORE</p>
    </a>
  </div>
</div>
