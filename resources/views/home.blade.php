...
<nav class="navbar navbar-expand-lg navbar-light scroll-down">
  ...
  <div class="collapse navbar-collapse ml-auto" id="navbarNavAltMarkup">
    ...
    <div class="navbar-nav">
      ...
      <div class="dropdown nav-item my-account-home">
      ...
      @else
      <a href="/login" class="icons"><i class="bi bi-person-circle text-body nav-text"></i><span class="nav-link text-body nav-text ml-0 my-account-home">LOG IN</span></a>
      @endif
    </div>
  </div>
  <div class="navbar-nav">
