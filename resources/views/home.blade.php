...
<nav class="navbar navbar-expand-lg navbar-light scroll-down">
  ...
  <div class="collapse navbar-collapse ml-auto" id="navbarNavAltMarkup">
    ...
    <div class="navbar-nav">
      <a href="https://wa.link/wrsgrl" class="navlink icons remove"><i class="bi bi-telephone-fill nav-text text-body"></i><span class="nav-text wa-number text-body">Whatsapp</span></a>
